...
import com.felfel.hello.api.GreetingMessage;
import com.felfel.hello.api.HelloService;
import com.felfel.hello.impl.HelloCommand.*;
...
public class HelloServiceImpl implements HelloService {
  ...
  @Override
  public Topic<com.felfel.hello.api.HelloEvent> helloEvents() {
    ...
    return TopicProducer.taggedStreamWithOffset(HelloEvent.TAG.allTags(), (tag, offset) ->
      ...
      com.felfel.hello.api.HelloEvent eventToPublish;
      ...
      if (eventAndOffset.first() instanceof HelloEvent.GreetingMessageChanged) {
        ...
        eventToPublish = new com.felfel.hello.api.HelloEvent.GreetingMessageChanged(
